...
import { fetchAllProducts, fetchBrandProducts, fetchCategoryProducts, fetchProductById } from "@/_actions"
...
const BrandProducts = ({ initialProducts, paginationRes: pagination, slug }: Props) => {
  ...
  const fetchMore = useCallback(async () => {
    if (!isFetching) {
      setIsFetching(true)
      const res = await fetchBrandProducts(slug, {
